...
> Design reference: verify operational details against [`AGENTS.md`](../../AGENTS.md).
...
| `enrollments.gs` | Enrollments | Teacher-class-subject assignment with conflict detection, reassign confirmation, and CSV import |
